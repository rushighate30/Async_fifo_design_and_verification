  ...
  <ul>
    ...
    <li>
      ...
      <ul>
       ...
       <ul>
        <li><a href="#verification">Waveform</a></li>
      </ul>
    </li>
...
<h3 id="execution">SystemVerilog Simulation Execution</h3>
...
<p style="text-align: justify;">
  After the simulation, the waveform file was analyzed to verify FIFO operations, including proper synchronization of read and write clocks, data transfer, and status flag transitions. The results confirm that the FIFO design performs as expected under all test conditions.
</p>

<h3 id="waveforms">Waveforms</h3>
<p><img src="Design_Verification_Result/Waveform.png" alt="Verification Waveform" width="1000"></p>
<div style="text-align: center; margin: 20px 0;">
  <p style="text-align: center; font-style: italic; font-size: 14px;">
    Figure 8 : Verification waveform of the <code>testbench.sv</code> showing FIFO write, read, full, and empty conditions (Generated by ModelSim)
  </p>
</div>
