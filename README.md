...
<p style="text-align: justify;">
  <a href="rtl_file/main.v">
    <code>./Verilog_code/main.v</code>
  </a> is the top-level module of the async FIFO. It integrates the memory, write/read pointer handlers, and 2FF synchronizers. All signals are properly connected across clock domains.
</p>
<p style="text-align: justify;">
  The module supports configurable data width and address size. It generates <code>fifo_full</code> and <code>fifo_empty</code> flags using synchronized Gray pointers.
</p>

<div style="text-align: center; margin: 20px 0;">
  <img src="Design_Verification_Result/Schematic.png" alt="main.v RTL Schematic" width="900" style="border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.2);" />
  <p style="text-align: center; font-style: italic; font-size: 14px;">Figure: RTL Schematic of main.v (Generated by Vivado/Quartus)</p>
</div>
