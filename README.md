...
<div style="text-align: center; margin: 20px 0;">
  <img src="IP_Block_Design/Wrapping_top.png" alt=" Async_FIFO_design_1_wrapper.v read_2FF.sv RTL Schematic" width="1000" style="border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.2);" />
  <p style="text-align: center; font-style: italic; font-size: 14px;">Figure 12.2: IP Design Wrapping Converted in RTL Top module Async_FIFO_design_1_wrapper.v (Generated by Vivado schematic)
  </p>
</div>
